...
import com.borshevskiy.currencyexchangetestapp.databinding.FavCurrencyItemBinding
...
class FavCurrencyAdapter @Inject constructor(private val mainViewModel: MainViewModel): ListAdapter<Currency, FavCurrencyAdapter.CurrencyViewHolder>(CurrencyDiffCallback) {
    ...
    class CurrencyViewHolder(val binding: FavCurrencyItemBinding):RecyclerView.ViewHolder(binding.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) =
        CurrencyViewHolder(FavCurrencyItemBinding.inflate(LayoutInflater.from(parent.context),parent,false))
    ...
    override fun onBindViewHolder(holder: CurrencyViewHolder, position: Int) {
        ...
        with(holder.binding) {
            ...
            isFavorite.setOnClickListener {
                mainViewModel.deleteFromFavorites(favCurrency)
            }
        }
    }
}