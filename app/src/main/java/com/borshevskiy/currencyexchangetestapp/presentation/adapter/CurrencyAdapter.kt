...
class CurrencyAdapter @Inject constructor(private val mainViewModel: MainViewModel): ListAdapter<Currency, CurrencyAdapter.CurrencyViewHolder>(CurrencyDiffCallback) {
    ...
    override fun onBindViewHolder(holder: CurrencyViewHolder, position: Int) {
        ...
        with(holder.binding) {
            ...
            isFavorite.setOnClickListener {
                mainViewModel.insertToFavorites(currency)
            }
        }
    }
}